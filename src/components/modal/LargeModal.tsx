...
import { LargeModalType, EntityFormType } from "./modalType.ts";
...
const LargeModal = ({ titleModal, btnArray, typeOfModal, entityForm, onClose, children }: LargeModalProps) => {
